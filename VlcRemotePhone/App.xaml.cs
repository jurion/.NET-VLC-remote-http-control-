...
namespace VlcRemotePhone
{
    ...
    public sealed partial class App : Application
    {
        ...
        private static PlayedViewModel viewModel = null;

        private static VlcConnectSettings vlcSettings = new VlcConnectSettings();
        /// <summary>
        /// A static ViewModel used by the views to bind against.
        /// </summary>
        /// <returns>The MainViewModel object.</returns>
        public static PlayedViewModel ViewModel
        {
            get
            {
                // Delay creation of the view model until necessary
                if (viewModel == null)
                    viewModel = new PlayedViewModel();
